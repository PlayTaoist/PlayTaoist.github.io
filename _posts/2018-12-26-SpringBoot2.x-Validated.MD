---
title:  "SpringBoot2.0数据验证(一)"
categories: SpringBoot2.0
tags: SpringBoot2.0
author: LIUREN
---

# SpringBoot2.x 轻松搞定数据验证（一）
...
![name参数没传](http://www.codepeople.cn/imges/validated/001.png)

test3接口（price参数值过低）

![price参数值过低](http://www.codepeople.cn/imges/validated/001.png)