---
title:  "SpringBoot2.0数据验证(三)"
categories: SpringBoot2.0
tags: SpringBoot2.0
author: LIUREN
---

# SpringBoot2.x 轻松搞定数据验证（三）
...
![insert 接口](http://www.codepeople.cn/imges/validated/005.png)

错误格式

> update 接口

![update 接口](http://www.codepeople.cn/imges/validated/006.png)
